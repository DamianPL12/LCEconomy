...
public class SetLCoins extends SubComando{
    ...
    public String getSyntax() {
        return "/lcoins set <jugador> <cantidad>";
    }

    @Override
    public String getDescription() {
        return "Setear Lcoins.";
    }
    ...
    public void perform(Player p, String[] args) {
        if(args.length > 2){
            ...
            lc.setLCoins(amount);
            t.sendMessage(ChatColor.GREEN + "Se ha establecido " + ChatColor.GRAY + amount + ChatColor.GREEN +" LCoins a tu cuenta.");
            p.sendMessage(ChatColor.GREEN + "Se ha establecido " + ChatColor.GRAY + amount + ChatColor.GREEN +" LCoins a la cuenta de "+ChatColor.YELLOW+t.getName()+""+ChatColor.GREEN+".");
        }else{
