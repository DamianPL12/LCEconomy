...
public class GiveLCoins extends SubComando{
    ...
    public String getSyntax() {
        return "/lcoins give <jugador> <cantidad>";
    }
    ...
    public void perform(Player p, String[] args) {
        if(args.length > 2){
            ...
            lc.addLCoins(amount);
            t.sendMessage(ChatColor.GREEN + "Se han agregado " + ChatColor.GRAY + amount + ChatColor.GREEN +" LCoins a tu cuenta.");
            p.sendMessage(ChatColor.GREEN + "Se han agregado " + ChatColor.GRAY + amount + ChatColor.GREEN +" LCoins a la cuenta de "+ChatColor.YELLOW+t.getName()+""+ChatColor.GREEN+".");
        }else{
