...
public class SetVipPoints extends SubComando{
    ...
    public String getSyntax() {
        return "/vippoints set <jugador> <cantidad>";
    }

    @Override
    public String getDescription() {
        return "Setear VipPoints.";
    }
    ...
    public void perform(Player p, String[] args) {
        if(args.length > 2){
            ...
            vp.setVipPoints(amount);
            t.sendMessage(ChatColor.GREEN + "Se ha establecido " + ChatColor.GRAY + amount + ChatColor.GREEN +" VipPoints a tu cuenta.");
            p.sendMessage(ChatColor.GREEN + "Se ha establecido " + ChatColor.GRAY + amount + ChatColor.GREEN +" VipPoints a la cuenta de "+ChatColor.YELLOW+t.getName()+""+ChatColor.GREEN+".");
        }else{
